                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Payement</strong>
                            </div>
                            <div class="card-body">
                       ...
                       $payement1C=new payementC();
                            $listepayements=$payement1C->afficherpayements();
?>
                                <table class="table table-striped table-bordered">
                                        ...
                                        <?PHP
                                        foreach($listepayements as $row){
                                            ?>
                                            <tr>
                                            <td><?PHP echo $row['adresse']; ?></td>
                                            <td><?PHP echo $row['nom_carte']; ?></td>
                                            <td><?PHP echo $row['num_carte']; ?></td>
                                            <td><?PHP echo $row['date_exp']; ?></td>
                                            <td><?PHP echo $row['code_secu']; ?></td>
      ...
      <div>
        <button type="button" class="btn btn-primary btn-lg"  style="margin-top:3%;margin-left:5%;border-radius: 5%;">
            <a href="ajoutPayement.php">Ajouter</a>
        </button>
      </div>
