            ...
            <div class="animated fadeIn">
                ...
                <div class="row" style=" justify-content: center;">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Ajouter Abonnement </h3>
                                        </div>
                                        <hr>
                                        <form action="ajoutAbn.php" method="POST" name="form">
                                            
                                            <div class="form-group">
                                                <label >ID-Abn</label>
                                                <input class="form-control" name="IDAbn" id="IDAbn">
                                                <div id="IDAbn1"></div>
                                            </div>
                                            <div class="form-group">
                                                <label >Nom_salle</label>
                                                </br>
                                                <select class="browser-default custom-select"name="Nom_salle" >
                                    ...
                                    <option value="1Mois">1Mois</option>
                                    ...
                                    <option value="1an">1an</option>
                                           ...
                                           <!-- <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input  type="submit" class="btn btn-lg btn-info btn-block"  name="ajouter" value="Ajouter" onclick="return verif()">
                                                </div>
                                        </form>
                                    </div>
                                </div>
                    ...
                    <!--/.col-->
                            ...
                            <script >
                              function verif(){
    if(document.form.Tarif.value == "" ){
        document.getElementById("Tarif").style.backgroundColor = "#FFA07A" ;
        document.getElementById("Tarif1").textContent = "Veuillez remplir ce champs" ;
        return false ;
    }else if(document.form.IDAbn.value == ""){
        
            document.getElementById("IDAbn").style.backgroundColor = "#FFA07A" ;
            document.getElementById("IDAbn1").textContent = "Veuillez remplir ce champs" ;
            return false ;
