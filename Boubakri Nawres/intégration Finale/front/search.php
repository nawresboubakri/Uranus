		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
                   ...
                   <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".materiel">

						Matériel
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".vetements">
						Vetements
					</button>
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".chaussures">
						Chaussures
					</button>
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					<div class="bor8 dis-flex p-l-15">
						...
						<button type="submit" name="submit"> <i class="zmdi zmdi-search"></i>  </button> 
              ...
              <?php 
				$s=0;
                        ...
                        //  $search=$_POST['search'];
                          	...
                          	$sqla ="SELECT * from produit WHERE nom_prod LIKE '%$search%'";
                          	$res = mysqli_query($connect,$sqla);
                          	$queryResult =mysqli_num_rows($res);
                          
                           echo 
                               "
                               These are ".$queryResult." results ! 
                               " 
                             ;
                            ?> 
...
?>  
			  ...
			  <div class="row isotope-grid"> 
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item isotope-item <?php echo $cat ?> <?php echo $sexe ?> <?php echo $nom_prod ?>">
					...
					<div class="block2">
						...
						<div class="block2-pic hov-img0">
                              ...
                              <img src ="<?php echo $src?>"alt="IMG-PRODUCT" /><br/>
                                 
						
							<a href="product-detail.php?ref_prod=<?php echo $ref_prod ?>&nom_prod=<?php echo $nom_prod ?>&prix_prod=<?php echo $prix_prod ?>&cat=<?php echo $cat ?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 "> 
								Quick View
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<!-- start  block add to wishlists -->
                              

							<div class="block2-txt-child2 flex-r p-t-3">
								<a  class="btn-addwish-b2 dis-block pos-relative js-addwish-b2" href="../frontend/shoping-cart.php?ref_prod=<?php echo $ref_prod ?>&nom_prod=<?php echo $nom_prod ?>&prix_prod=<?php echo $prix_prod ?>" name="add_to_cart">
					...
					<div class="col-md-6 col-lg-7 p-b-30">
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							...
							<div class="slick3 gallery-lb">
									<div class="item-slick3"  data-thumb="image/<?php echo $row['nom_prod']?>"> 
