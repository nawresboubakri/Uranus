                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?PHP
                                     ...
                                     ?>
                                            ...
                                            <!-- <form action="supprimerProduit.php" method="POST" id="from1" data-flag="0"> -->
                                              <form action="supprimerProduit.php" method="POST"  >
                                            <!--   <button type="submit" class="btn btn-primary btn-lg" style="margin-top:3%;margin-left:5%;border-radius: 5%;"onclick="return confirm('Etes-vous sur de vouloir supprimer ce produit ?')"> -->
                                              <button type="submit" class="btn btn-primary btn-lg" style="margin-top:3%;margin-left:5%;border-radius: 5%;" onclick="return fadit()" >
...
-->
        ...
        <div>
            <button type="button" class="btn btn-primary btn-lg"  style="margin-top:3%;margin-left:5%;border-radius: 5%;">
                <a href="ajoutCategorie.php">Ajouter</a>
            </button>
          </div>
