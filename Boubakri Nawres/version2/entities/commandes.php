...
class commandes{
     ...
     private $mod_paiement;
function __construct($ref_prod,$username,$categorie,$prix_total,$jour_arrivee,$mod_paiement){
    $this->ref_prod=$ref_prod; 
    $this->username=$username;  
    $this->categorie=$categorie;  
    $this->prix_total=$prix_total;   
    $this->jour_arrivee=$jour_arrivee;  
    $this->mod_paiement=$mod_paiement;  
} 
...
function get_mod_paiement(){
    return $this->mod_paiement;
}
...
function setmod_paiement($mod_paiement){
    $this->mod_paiement=$mod_paiement;
}
