				...
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					...
					?>
								<tr class="table_row">
									...
									<td class="column-5"><?php echo number_format($values["item_quantite"] * $values["item_prix_prod"], 2);?></td>

									<td><a href="shoping-cart.php?action=delete&ref_prod=<?php echo $values["item_ref_prod"]; ?>"><span class="text-danger">Remove</span></a></td>
									<td name="username" type="hidden" value="<?php echo $_SESSION['username']?>"></td>
                                    <td  type="hidden" name="categorie" id="categorie"value="mohsen" <?php $categorie="vetement"; echo $categorie;?>></td>
                                    <td  type="hidden" name="jour d'arrivee" id="jour d'arrivee" value="mohsen"<?php $jour_arrivee="01-02-2011"?>></td>
                                    <td  type="hidden" name="mode de paiment" id="mode de paiment" value="mohsen"<?php $mod_paiement="money"; echo $mod_paiement;?>></td>
					</tr>
					<?php
							$total = $total + ($values["item_quantite"] * $values["item_prix_prod"]);
						}
					?>
					<tr>
...
<td align="center" colspan="2"> <button class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10"  ><a href="ajoutercommandes.php?ref_prod=<?php echo $values["item_ref_prod"]; ?>&username=<?php echo $_SESSION["username"]; ?>&categorie=<?php echo $categorie;?>&prix_total=<?php echo $total; ?>&jour_arrivee=<?php echo $jour_arrivee; ?>&mod_paiement=<?php echo $mod_paiement; ?>" >passer la commande </a></button> 
						...
						<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
							<div class="flex-w flex-m m-r-20 m-tb-5">
								<input class="stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5" type="text" name="coupon" placeholder="code de la carte client">
									
								<div class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5">
									code de la carte client
								</div>
							...
							<div class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
								passer la commande sans livraison
							</div>
						</div>
					</div>
				</div>
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<div class="p-t-15">
									...
									<div class="bor8 bg0 m-b-12">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="state" placeholder="Ville / Cité">
									</div>

									<div class="bor8 bg0 m-b-22">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Code Postale">
									</div>
