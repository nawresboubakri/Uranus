...
if (isset($reff)){
//$results=$commentC->recupererComment( $reff );


	$results=$commentC->recupererComment( $ref_prod );
	...
	//if(isset($_SESSION["product-detail"]))
	//{
		//$item_array_ref_prod = array_column($_SESSION["product-detail"], "item_ref_prod");
		//if(!in_array($_GET["ref_prod"], $item_array_ref_prod))
		///{
		//	$count = count($_SESSION["product-detail"]);
		//	$item_array = array(
			...
			//);
			//$_SESSION["product-detail"][$count] = $item_array;
		//}
		//else
		//{
...
/*	else
	{
		...
		$_SESSION["product-detail"][0] = $item_array;
	}*/
...
?>
		...
		<?php
					//if(!empty($_SESSION["product-detail"]))
				//	{
						
						//foreach($_SESSION["product-detail"] as $keys => $values)
						//{
					?>
									...
									<div class="p-b-30 m-lr-15-sm"> 
										...
										<div class="flex-w flex-t p-b-68">
                                         ...
                                         <div class="size-207">
												...
												<!--	<?php echo $values["item_comment"]; ?></td>  -->
												</p>
											</div>
...
//}
										...
										<!-- Add review -->
										<form class="w-full" method="POST" action="product-detail.php">
 ...
 <!-- debut script des étoiles -->

<?php //} ?>

<!--fin script des étoiles -->
											...
											-->
												...
												<!--<div class="col-sm-6 p-b-5">
												 ...
												 <div>
												 	    <label class="stext-102 cl3" for="email"> Référence de produit</label>
		                                               <!-- <input type="number" name="ref_prod" value="<?php echo $row['ref_prod'] ?>" class="size-111 bor8 stext-102 cl2 p-lr-20"> -->

		                                               <input type="number" name="ref_prod" value="<?php echo $reff ?>" class="size-111 bor8 stext-102 cl2 p-lr-20">
	                                            </div>
											</div>
