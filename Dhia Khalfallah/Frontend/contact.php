...
$sql ="SELECT ref_cmd FROM commandes"; 
	...
	<header>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="shoping-cart.html" class="label1 rs1" data-label1="hot">Commande</a>
				</li>
		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form method="POST" action="ajoutRec.php" onSubmit="verif_mail()">
						<h4 class="mtext-105 cl2 txt-center p-b-30">
							Envoyer-nous une réclamation
						</h4>

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="mail" id="mail" placeholder="Votre adresse mail">
							<img class="how-pos4 pointer-none" src="images/icons/icon-email.png" alt="ICON">
						</div>	
						<div class="bor8 m-b-20 how-pos4-parent">

						<div class="size-350 respon6-next m-b-20 how-pos4-parent ">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="idc">
											<option>ID de votre commande</option>
											<option></option>
                                               <?php while($row1=mysqli_fetch_array($req_theme)):;?>
                                               <option><?php echo $row1["ref_cmd"];?></option>
                                               <?php endwhile ?>
						...
						<div class="size-350 respon6-next m-b-20 how-pos4-parent ">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="sujet">
											<option>Sujet</option>
											<option>Produit(s) endommagé(s)</option>
											<option>Probléme de livraison </option>
											<option>Produit(s) manquant(s)</option>
						...
						<div class="bor8 m-b-30">
							<textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="details" placeholder="Comment pourrion-nous vous aider ?"></textarea>
						</div>
				...
				<div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
					...
					<div class="flex-w w-full">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl1 size-213 p-t-18">
								serviceclients.sport@gmail.com
							</p>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
 ...
 if(!test)
 	alert('Veuillez Verifier votre le format du mail saisie');
	}
