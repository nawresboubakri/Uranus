        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-area-chart"></i><a href="Gra_offres.html"> GraphiqueProduit</a></li>
                    </ul>
                </li>
...
if($row['sujet']=='Produit(s) endommagé(s)'){
    $i++;
}
else if($row['sujet']=='Probléme de livraison'){
    $j++;
}else
if($row['sujet']=='Produit(s) manquant(s)'){
    $l++;
}
 ...
 $dataPoints = array(
     array("label"=> "Produit(s) endommagé(s)", "y"=>$i ),
     array("label"=> "Probléme de livraison", "y"=> $l),
     array("label"=> "Produit(s) manquant(s)", "y"=> $j),
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	exportEnabled: true,
	title:{
		text: "Les types de réclamations"
	},
	subtitles: [{
		text: "Le nombre total "
	}],
	data: [{
		type: "pie",
		showInLegend: "true",
...
Morris.Bar({
 ...
 xkey:'pour_reduc',
 //ykeys:['prix_total'],
 ykeys:['ref_off', 'id_prod'],
 labels:['ref_off', 'id_prod'],
 hideHover:'auto',
 stacked:true
});
</script>