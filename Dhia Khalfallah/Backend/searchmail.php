                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Chercher les mails relatives</h3>
                                        </div>
                                        <hr>
                                        <form  method="POST" action="test.php">

                                                <label >L'ojbet de recherche:</label>
                                                <textarea placeholder="Le mot/Phrase clé dans l'objet" class="form-control" name="subject"></textarea>
                                            </div>
                                                <div>
                                        ...
                                        <div class="form-group">
                                                <form action="test2.php">
                                                    <button type="submit" class="btn btn-lg btn-info btn-block">
                                                        ...
                                                        <span >Afficher tout les mails</span>
                                                    </button>
                                                </form>
                                    </div>
                                </div>
