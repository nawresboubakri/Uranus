                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Réclamation</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Repondre </h3>
                                        </div>
                                        <hr>
                                        <form  method="POST" action="mail.php">

                                                <label >Ecriver votre Email</label>
                                                <textarea placeholder="Le contenu de votre mail..." class="form-control" name="email"></textarea>
                                            </div>
                                                <div>
                                                                                                  <input  type="hidden" value="<?PHP echo $_POST['usermail']; ?>" name="usermailing">
