<?php
 ...
 if ( !(empty($_POST['nom'])) && !(empty($_POST['prenom'])) && !(empty($_POST['cin'])) && !(empty($_POST['mail'])) && !(empty($_POST['tel'])) ){

$personel=new Personels($_POST['nom'],$_POST['prenom'],$_POST['cin'],$_POST['mail'],$_POST['tel']);

 $personelC= new PersonelsC() ; 

$personelC->ajouterPers($personel);
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Ajouter Personels </h3>
                                        </div>
                                        ...
                                        <!-- <form  method='POST'  name="f" id="f"  action="ajoutProduit.php"  enctype="multipart/form-data" novalidate   onSubmit="return verif_Produit()"> -->
                                            <form  method='POST' name="f" id="f"action="ajoutPersonels.php"  enctype="multipart/form-data" novalidate   onSubmit="return verif_Personels()">
                                            <div class="form-group body">
                                               ...
                                               <div class="form-group">
                                                ...
                                                class="form-control" name="nom" placeholder="Entrez le nom du personel" required="required" size="25"  autocomplete='off' class="form-control col-md-7 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                class="form-control" name="prenom" placeholder="Entrez le prenom de personel" required="required" size="25"  autocomplete='off' class="form-control col-md-7 col-xs-12">
                                                <div id="prenom1" style="color: red;"></div>
                                            </div>
                                                <label>Carte d'identité</label>*
                                               
                                                <input type="number" id="cin" class="form-control"  name="cin" placeholder="Entrez le numero de la cin" required="required" min="8" max="8"  minlength="8" maxlength="8" size="8" autocomplete='off' data-validate-length="1,1" class=" col-md-7 col-xs-12" >
                                            <div id="cin1" style="color: red;"></div>
                                            </div> 
                                              <div class="form-group">
                                                <label >E-mail</label>*
                                                <input type="text" id="mail"
                                                class="form-control" name="mail" placeholder="Entrez le mail de personel" required="required" size="25"  autocomplete='off' class="form-control col-md-7 col-xs-12">
                                                <div id="mail1" style="color: red;"></div>
                                              <label>Numero de telephone</label>*
                                               
                                                <input type="number" id="tel" class="form-control"  name="tel" placeholder="Entrez le numero de telephone" required="required" min="8" max="8"  minlength="8" maxlength="8" size="8" autocomplete='off' data-validate-length="1,1" class=" col-md-7 col-xs-12" >
                                            <div id="tel1" style="color: red;"></div>
                                            </div> 
