                                        ...
                                        <div class="card-title">
                                            <h3 class="text-center">Modifier Catégorie </h3>
                                              ...
                                              <?PHP
                                                   ...
                                                   $result=$categorieC->recupererCategorie($_GET['ref_cat']);
                                            ...
                                            ?>
                                        <form  method="POST" action="test-modifCategorie.php" >

                                            
                                            <div class="form-group">
                                                <label >Nom de la categorie</label>
                                                <input type="text" name="cat" value="<?PHP echo $cat ?>" class="form-control">

                                            </div>
                                             <div class="form-group">
                                                <label >Réfférence  de la categorie</label>
                                                <input type="number" name="ref_cat" value="<?PHP echo $ref_cat ?>" class="form-control">

                                            </div>
                                            <div class="form-group">
                                                <label >Generation</label>
                                                <input type="text" name="generation" value="<?PHP echo $generation ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label >Marque</label>
