...
<body>
                    ...
                    <div class="col-lg-6" >
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Club</strong>
                            </div>
                            <div class="card-body" >
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Ajouter Club</h3>
                                        </div>
                                        <hr>
                                        <form method="post"   action="ajoutClub.php"name="form" novalidate="novalidate">
                                            ...
                                            <select class="browser-default custom-select"name="Categorie" id="Categorie"required >
                                                 <option selected>Choisir une catégorie</option>
                                    <option value="Fitness">Fitness</option>
                                    <option value="Centre de soin">Centre de soin</option>
                                    <option value="Centre de réeducation">Centre de rééducation</option>
                                  ...
                                  <div id="Categorie1"></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input  type="submit" class="btn btn-lg btn-info btn-block" id="ajouter" name="ajouter" value="Ajouter" onclick="return verif()">
    ...
    if(document.form.Nom.value == "" ){
        ...
        return false ;
    }else if(document.form.Categorie.value == ""){
    ...
    }else if(document.form.Region.value == ""){
        document.getElementById("Region").style.backgroundColor = "#FFA07A" ;
            document.getElementById("Region1").textContent = "Veuillez remplir ce champs" ;
            return false ;
    }else if(document.form.Adresse.value == ""){
        document.getElementById("Adresse").style.backgroundColor = "#FFA07A" ;
            document.getElementById("Adresse1").textContent = "Veuillez remplir ce champs" ;
            return false ;
    }else if(document.form.Horaire.value == ""){
        document.getElementById("Horaire").style.backgroundColor = "#FFA07A" ;
            document.getElementById("Horaire1").textContent = "Veuillez remplir ce champs" ;
            return false ;
    }else{return true ;}
}
