...
?>
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                          <form action="modifier_co.php" method="post" >
                                           ...
                                           <div >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input  class="form-control" type="number" name="ref_prod" value="<?PHP echo $ref_prod ?>">
                                            </div>
                                            <div class="form-group">
                                                <label >prix total</label>
                                                <input  class="form-control" type="number" name="prix_total" value="<?PHP echo $prix_total ?>">
                                            </div>
                                            <div class="form-group">
                                                <label >jour d'arrivee</label>
                                                <input type="date" class="form-control" name="jour_arrivee" value="<?PHP echo $jour_arrivee ?>" >
                                            </div>
