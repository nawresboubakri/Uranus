             ...
             <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
						   <a href="mode_payement.php?ref_cmd=<?php   echo $_SESSION['ref_cmd']; ?>&destination=<?php   echo $_POST['destination']; ?>&code_postal=<?php echo  $_POST['Code_Postale'];?>&periode_arrivee=<?php echo date('Y-m-d', strtotime(' + 2 days')); ?>&prix_total=<?php echo $_SESSION['prix_total']; ?> " >passer la caisse </a>
                        </button>
