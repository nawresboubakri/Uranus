                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="table-clubs">Club</a></li>
...
if (isset($_GET['IDAbn'])){
    $result1=$Abn2->recupererAbn($_GET['IDAbn']);
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Modifier Abonnement :<?php echo $row['IDAbn'];?></h3>
                                        </div>
                                        <hr>
                                        <form action="modifAbn.php" method="post"> <!-- novalidate="novalidate"-->
                                            <div>
                                       
                                            </div>
                                            <div class="form-group">
                                                <label >ID</label>
                                                <input type="text" class="form-control"  value="<?php echo $row['IDAbn'];?>" name="IDAbn_">
                                            </div>
                                            <div class="form-group">
                                                <label >Nom Salle</label>
                                                <input type="text" class="form-control" value="<?php echo $row['Nom_salle'];?>" name="Nom_salle">
                                            </div>
                                            <div class="form-group">
                                                <label >Durée</label>
                                                <input type="text" class="form-control" value="<?php echo $row['Duree'];?>" name="Duree">
                                            </div>
                                            <div class="form-group">
                                                <label >Tarif</label>
                                                <input type="text" class="form-control" value="<?php echo $row['Tarif'];?>" name="Tarif" >
                                            </div>
                                           
                                           
                                            
                                                <div>
                                                	<input type="submit" name="modifierAbns" value="modifier">
                                                    <input type="hidden" name="id_ini" value="<?PHP echo $_GET['IDAbn'];?>">
