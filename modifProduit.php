                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                            ...
                                            ?>
                                        <form  method="POST" action="test-modifier.php" >

                                            
                                            <div class="form-group">
                                                <label >Ref_Produit</label>
                                                <input type="number" name="ref_prod" value="<?PHP echo $ref_prod ?>" class="form-control">

                                            </div>
                                            <div class="form-group">
                                                <label >Nom de produit</label>
                                                <input type="text" name="nom_prod" value="<?PHP echo $nom_prod ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="description_prod" value="<?PHP echo $description_prod ?>">
                                            </div>
                                            <div class="form-group">
                                                <label >Disponibilite de produit</label>
                                                <input type="text" class="form-control" name="disponibilite" value="<?PHP echo $disponibilite ?>" >
                                            </div>
                                            <div class="form-group">
                                                <label >Prix de produit</label>
                                                <input type="number" class="form-control"name="prix_prod" value="<?PHP echo $prix_prod ?>"> 
                                            </div>
                                            <div class="form-group">
