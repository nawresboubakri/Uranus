						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									...
									<td><a href="shoping-cart.php?action=delete&ref_prod=<?php echo $values["item_ref_prod"]; ?>"><span class="text-danger"><i class="fa fa-trash" style="background-color:none ;"></i></span></a></td>
